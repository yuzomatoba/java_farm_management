...
public class SecurityFilter extends OncePerRequestFilter {
    ...
    @Override
    protected void doFilterInternal(HttpServletRequest myRequest, HttpServletResponse myResponse, FilterChain myFilterChain) throws ServletException, IOException {
