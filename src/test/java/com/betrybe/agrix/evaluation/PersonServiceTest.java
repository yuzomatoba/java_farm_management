...
public class PersonServiceTest {
  ...
  @BeforeEach
  public void setUp() {
    myPersonService.setPasswordEncoder(myPasswordEncoder);
  }
  ...
  public void personCreationTest() {
    ...
    String encryptedPassword = "$2a$10$k78Bf05kwBMOGp51OIsHp.OjO2bJgNkbxWuJ4dobAVZJSMJUmZKpe";
    Mockito.when(myPasswordEncoder.encode(eq(myPerson.getPassword())))
            .thenReturn(encryptedPassword);

    Person returnedMyPerson = new Person();
    returnedMyPerson.setId(2L);
    returnedMyPerson.setUsername(myPerson.getUsername());
    returnedMyPerson.setPassword(encryptedPassword);
    ...
    assertEquals(encryptedPassword, savedMyPerson.getPassword());
